...
from P2_RemoveBG.src.models.modnet import MODNet
...
def get_url(im_names):
    ...
    pretrained_ckpt = 'P2_RemoveBG/pretrained/modnet_photographic_portrait_matting.ckpt'
